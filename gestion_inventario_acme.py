...
def reporte_productos():
    ...
    for item in inventario:
        ...
        reporte_productos[codigo]["total_cantidad"] += cantidad
    ...
    for codigo, info in reporte_productos.items():
        ...
        archivo_txt.append(f" Total cantidad bodegas: {info['total_cantidad']}")
        archivo_txt.append(f" Total stock bodegas: {info['total_stock']}")
        for nombre_bodega, datos_bodega in info["bodegas"].items():
            archivo_txt.append(f" -{nombre_bodega}: cantidad={datos_bodega['cantidad']}, stock={datos_bodega['stock']}")
